...
public class Main {
   ...
   private static void forceUpgrade(LevelStorageSource.LevelStorageAccess pLevelStorage, DataFixer pFixer, boolean pClearHeightAndLightMaps, BooleanSupplier p_195492_, WorldGenSettings pWorldGenSettings) {
      LOGGER.info("Forcing world upgrade!");
      WorldUpgrader worldupgrader = new WorldUpgrader(pLevelStorage, pFixer, pWorldGenSettings, pClearHeightAndLightMaps);
