...
public class StructureCheck {
   ...
   @Nullable
   private StructureCheckResult tryLoadFromStorage(ChunkPos pChunkPos, Structure pStructure, boolean p_226736_, long p_226737_) {
      ...
      if (!(tag instanceof CompoundTag compoundtag)) {
         ...
         if (i <= 1493) {
            ...
            if (object2intmap == null) {
               ...
               return this.checkStructureInfo(object2intmap, pStructure, p_226736_);
            }
         }
      }
   }
