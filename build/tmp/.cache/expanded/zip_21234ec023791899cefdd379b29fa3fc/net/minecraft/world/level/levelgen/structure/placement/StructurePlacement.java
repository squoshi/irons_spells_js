...
public abstract class StructurePlacement {
   ...
   private static boolean probabilityReducer(long pLevelSeed, int pRegionX, int pRegionZ, int pSalt, float p_227038_) {
   ...
   private static boolean legacyProbabilityReducerWithDouble(long pBaseSeed, int p_227050_, int pChunkX, int pChunkZ, float p_227053_) {
      WorldgenRandom worldgenrandom = new WorldgenRandom(new LegacyRandomSource(0L));
      worldgenrandom.setLargeFeatureSeed(pBaseSeed, pChunkX, pChunkZ);
      return worldgenrandom.nextDouble() < (double)p_227053_;
   }

   private static boolean legacyArbitrarySaltProbabilityReducer(long pLevelSeed, int p_227062_, int pRegionX, int pRegionZ, float p_227065_) {
      WorldgenRandom worldgenrandom = new WorldgenRandom(new LegacyRandomSource(0L));
