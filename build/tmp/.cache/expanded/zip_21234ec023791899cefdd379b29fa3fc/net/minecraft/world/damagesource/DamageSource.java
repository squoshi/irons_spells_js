...
public class DamageSource {
   ...
   /**
    * Returns an {@link net.minecraft.world.damagesource.EntityDamageSource} of type player.
    */
   ...
   /**
    * Returns the {@link net.minecraft.world.damagesource.IndirectEntityDamageSource} of an arrow.
    */
   ...
   /**
    * Returns the {@link net.minecraft.world.damagesource.EntityDamageSource} of the Thorns enchantment.
    */
   ...
   /**
    * Returns {@code true} if the damage is projectile based.
    */
   ...
   /**
    * Returns {@code true} if the damage is fire based.
    */
   ...
   /**
    * Returns {@code true} if the damage is magic based.
    */
