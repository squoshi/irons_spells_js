...
public class BehaviorUtils {
   ...
   public static void throwItem(LivingEntity pEntity, ItemStack pStack, Vec3 p_217136_, Vec3 p_217137_, float pYOffset) {
      ...
      Vec3 vec3 = p_217136_.subtract(pEntity.position());
