...
public class ChunkPalettedStorageFix extends DataFix {
   ...
   private static void addBeds(Map<String, Dynamic<?>> pMap, int p_15075_, String pBedColor) {
      pMap.put("southfalsefoot" + p_15075_, BlockStateData.parse("{Name:'minecraft:" + pBedColor + "_bed',Properties:{facing:'south',occupied:'false',part:'foot'}}"));
      pMap.put("westfalsefoot" + p_15075_, BlockStateData.parse("{Name:'minecraft:" + pBedColor + "_bed',Properties:{facing:'west',occupied:'false',part:'foot'}}"));
      pMap.put("northfalsefoot" + p_15075_, BlockStateData.parse("{Name:'minecraft:" + pBedColor + "_bed',Properties:{facing:'north',occupied:'false',part:'foot'}}"));
      pMap.put("eastfalsefoot" + p_15075_, BlockStateData.parse("{Name:'minecraft:" + pBedColor + "_bed',Properties:{facing:'east',occupied:'false',part:'foot'}}"));
      pMap.put("southfalsehead" + p_15075_, BlockStateData.parse("{Name:'minecraft:" + pBedColor + "_bed',Properties:{facing:'south',occupied:'false',part:'head'}}"));
      pMap.put("westfalsehead" + p_15075_, BlockStateData.parse("{Name:'minecraft:" + pBedColor + "_bed',Properties:{facing:'west',occupied:'false',part:'head'}}"));
      pMap.put("northfalsehead" + p_15075_, BlockStateData.parse("{Name:'minecraft:" + pBedColor + "_bed',Properties:{facing:'north',occupied:'false',part:'head'}}"));
      pMap.put("eastfalsehead" + p_15075_, BlockStateData.parse("{Name:'minecraft:" + pBedColor + "_bed',Properties:{facing:'east',occupied:'false',part:'head'}}"));
      pMap.put("southtruehead" + p_15075_, BlockStateData.parse("{Name:'minecraft:" + pBedColor + "_bed',Properties:{facing:'south',occupied:'true',part:'head'}}"));
      pMap.put("westtruehead" + p_15075_, BlockStateData.parse("{Name:'minecraft:" + pBedColor + "_bed',Properties:{facing:'west',occupied:'true',part:'head'}}"));
      pMap.put("northtruehead" + p_15075_, BlockStateData.parse("{Name:'minecraft:" + pBedColor + "_bed',Properties:{facing:'north',occupied:'true',part:'head'}}"));
      pMap.put("easttruehead" + p_15075_, BlockStateData.parse("{Name:'minecraft:" + pBedColor + "_bed',Properties:{facing:'east',occupied:'true',part:'head'}}"));
   }

   private static void addBanners(Map<String, Dynamic<?>> pMap, int p_15098_, String pBannerColor) {
      for(int i = 0; i < 16; ++i) {
         pMap.put(i + "_" + p_15098_, BlockStateData.parse("{Name:'minecraft:" + pBannerColor + "_banner',Properties:{rotation:'" + i + "'}}"));
      }

      pMap.put("north_" + p_15098_, BlockStateData.parse("{Name:'minecraft:" + pBannerColor + "_wall_banner',Properties:{facing:'north'}}"));
      pMap.put("south_" + p_15098_, BlockStateData.parse("{Name:'minecraft:" + pBannerColor + "_wall_banner',Properties:{facing:'south'}}"));
      pMap.put("west_" + p_15098_, BlockStateData.parse("{Name:'minecraft:" + pBannerColor + "_wall_banner',Properties:{facing:'west'}}"));
      pMap.put("east_" + p_15098_, BlockStateData.parse("{Name:'minecraft:" + pBannerColor + "_wall_banner',Properties:{facing:'east'}}"));
   }
