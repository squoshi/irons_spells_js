...
public class Structures {
   ...
   public static final Holder<Structure> MINESHAFT = register(BuiltinStructures.MINESHAFT, new MineshaftStructure(structure(BiomeTags.HAS_MINESHAFT, GenerationStep.Decoration.UNDERGROUND_STRUCTURES, TerrainAdjustment.NONE), MineshaftStructure.Type.NORMAL));
   public static final Holder<Structure> MINESHAFT_MESA = register(BuiltinStructures.MINESHAFT_MESA, new MineshaftStructure(structure(BiomeTags.HAS_MINESHAFT_MESA, GenerationStep.Decoration.UNDERGROUND_STRUCTURES, TerrainAdjustment.NONE), MineshaftStructure.Type.MESA));
   ...
   public static final Holder<Structure> BURIED_TREASURE = register(BuiltinStructures.BURIED_TREASURE, new BuriedTreasureStructure(structure(BiomeTags.HAS_BURIED_TREASURE, GenerationStep.Decoration.UNDERGROUND_STRUCTURES, TerrainAdjustment.NONE)));
   public static final Holder<Structure> BASTION_REMNANT = register(BuiltinStructures.BASTION_REMNANT, new JigsawStructure(structure(BiomeTags.HAS_BASTION_REMNANT, TerrainAdjustment.NONE), BastionPieces.START, 6, ConstantHeight.of(VerticalAnchor.absolute(33)), false));
   public static final Holder<Structure> VILLAGE_PLAINS = register(BuiltinStructures.VILLAGE_PLAINS, new JigsawStructure(structure(BiomeTags.HAS_VILLAGE_PLAINS, TerrainAdjustment.BEARD_THIN), PlainVillagePools.START, 6, ConstantHeight.of(VerticalAnchor.absolute(0)), true, Heightmap.Types.WORLD_SURFACE_WG));
   public static final Holder<Structure> VILLAGE_DESERT = register(BuiltinStructures.VILLAGE_DESERT, new JigsawStructure(structure(BiomeTags.HAS_VILLAGE_DESERT, TerrainAdjustment.BEARD_THIN), DesertVillagePools.START, 6, ConstantHeight.of(VerticalAnchor.absolute(0)), true, Heightmap.Types.WORLD_SURFACE_WG));
   public static final Holder<Structure> VILLAGE_SAVANNA = register(BuiltinStructures.VILLAGE_SAVANNA, new JigsawStructure(structure(BiomeTags.HAS_VILLAGE_SAVANNA, TerrainAdjustment.BEARD_THIN), SavannaVillagePools.START, 6, ConstantHeight.of(VerticalAnchor.absolute(0)), true, Heightmap.Types.WORLD_SURFACE_WG));
   public static final Holder<Structure> VILLAGE_SNOWY = register(BuiltinStructures.VILLAGE_SNOWY, new JigsawStructure(structure(BiomeTags.HAS_VILLAGE_SNOWY, TerrainAdjustment.BEARD_THIN), SnowyVillagePools.START, 6, ConstantHeight.of(VerticalAnchor.absolute(0)), true, Heightmap.Types.WORLD_SURFACE_WG));
   public static final Holder<Structure> VILLAGE_TAIGA = register(BuiltinStructures.VILLAGE_TAIGA, new JigsawStructure(structure(BiomeTags.HAS_VILLAGE_TAIGA, TerrainAdjustment.BEARD_THIN), TaigaVillagePools.START, 6, ConstantHeight.of(VerticalAnchor.absolute(0)), true, Heightmap.Types.WORLD_SURFACE_WG));
   ...
   public static final Holder<Structure> RUINED_PORTAL_OCEAN = register(BuiltinStructures.RUINED_PORTAL_OCEAN, new RuinedPortalStructure(structure(BiomeTags.HAS_RUINED_PORTAL_OCEAN, TerrainAdjustment.NONE), new RuinedPortalStructure.Setup(RuinedPortalPiece.VerticalPlacement.ON_OCEAN_FLOOR, 0.0F, 0.8F, false, false, true, false, 1.0F)));
   public static final Holder<Structure> RUINED_PORTAL_NETHER = register(BuiltinStructures.RUINED_PORTAL_NETHER, new RuinedPortalStructure(structure(BiomeTags.HAS_RUINED_PORTAL_NETHER, TerrainAdjustment.NONE), new RuinedPortalStructure.Setup(RuinedPortalPiece.VerticalPlacement.IN_NETHER, 0.5F, 0.0F, false, false, false, true, 1.0F)));
   public static final Holder<Structure> ANCIENT_CITY = register(BuiltinStructures.ANCIENT_CITY, new JigsawStructure(structure(BiomeTags.HAS_ANCIENT_CITY, Arrays.stream(MobCategory.values()).collect(Collectors.toMap((p_236555_) -> {
      return p_236555_;
   }, (p_236551_) -> {
   ...
   public static Holder<? extends Structure> bootstrap(Registry<Structure> pRegistry) {
      return MINESHAFT;
   }
