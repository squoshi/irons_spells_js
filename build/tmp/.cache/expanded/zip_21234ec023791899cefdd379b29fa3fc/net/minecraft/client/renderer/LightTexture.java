...
public class LightTexture implements AutoCloseable {
   ...
   private float calculateDarknessScale(LivingEntity pEntity, float p_234314_, float p_234315_) {
      float f = 0.45F * p_234314_;
      return Math.max(0.0F, Mth.cos(((float)pEntity.tickCount - p_234315_) * (float)Math.PI * 0.025F) * f);
   }
