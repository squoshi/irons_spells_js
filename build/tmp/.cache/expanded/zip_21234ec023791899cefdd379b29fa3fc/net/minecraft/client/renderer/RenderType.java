...
public abstract class RenderType extends RenderStateShard {
   ...
   public static RenderType entityTranslucentEmissive(ResourceLocation pLocation, boolean p_234337_) {
      return ENTITY_TRANSLUCENT_EMISSIVE.apply(pLocation, p_234337_);
   }
