...
public final class OptionInstance<T> {
   ...
   public OptionInstance(String pKey, OptionInstance.TooltipSupplierFactory<T> pTooltip, OptionInstance.CaptionBasedToString<T> p_231486_, OptionInstance.ValueSet<T> pValues, Codec<T> pCodec, T pInitialValue, Consumer<T> pOnValueUpdate) {
